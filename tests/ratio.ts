...
describe("ratio", () => {
  before(async () => {
    ...
    console.log('currency mint', deployer.currency.mint.toString(), deployer.currency.bump)
    console.log('currency state', deployer.state.pda.toString(), deployer.state.bump)
    console.log('currency pool', deployer.pool.pda.toString(), deployer.pool.bump, deployer.pool.currency.pda.toString())
  });
